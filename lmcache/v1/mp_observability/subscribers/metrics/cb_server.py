...
class BlendMetricsSubscriber(EventSubscriber):
    ...
    _SUBMITTED_TO_STAGE: dict[EventType, tuple[str, str]] = {
    ...
    _START_TO_STAGE: dict[EventType, str] = {
        EventType.CB_STORE_PRE_COMPUTED_START: "cb_store_pre_computed_gpu_start",
        EventType.CB_RETRIEVE_START: "cb_retrieve_pre_computed_gpu_start",
        EventType.CB_STORE_FINAL_START: "cb_store_final_gpu_start",
    }
    _END_TO_STAGE: dict[EventType, str] = {
        EventType.CB_STORE_PRE_COMPUTED_END: "cb_store_pre_computed_gpu_end",
        EventType.CB_RETRIEVE_END: "cb_retrieve_pre_computed_gpu_end",
        EventType.CB_STORE_FINAL_END: "cb_store_final_gpu_end",
    }
    ...
    def _on_l0_submitted(self, event: Event) -> None:
        operation, stage = self._SUBMITTED_TO_STAGE[event.event_type]
        append_cb_l0_boundary_event(
    ...
    def _on_l0_end(self, event: Event) -> None:
        ...
        append_cb_l0_boundary_event(
            source="lmcache_blend_server_v2",
            stage=self._END_TO_STAGE[event.event_type],
            request_id=event.session_id,
            operation=operation,
            instance_id=instance_id,
