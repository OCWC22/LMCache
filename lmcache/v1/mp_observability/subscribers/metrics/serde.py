...
class SerdeMetricsSubscriber(EventSubscriber):
    ...
    _START_TO_DIRECTION: dict[EventType, str] = {
        EventType.CB_SERDE_ENCODE_START: "encode",
        EventType.CB_SERDE_DECODE_START: "decode",
    }
    _END_TO_START: dict[EventType, EventType] = {
        EventType.CB_SERDE_ENCODE_END: EventType.CB_SERDE_ENCODE_START,
        EventType.CB_SERDE_DECODE_END: EventType.CB_SERDE_DECODE_START,
    }
